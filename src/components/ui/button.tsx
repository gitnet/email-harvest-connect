...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-gradient-primary text-primary-foreground hover:shadow-button hover:scale-105 shadow-soft",
        ...
        hero: "bg-background/10 backdrop-blur-sm text-background border border-background/20 hover:bg-background/20 hover:shadow-button transition-all duration-300",
        gradient: "bg-gradient-hero text-background font-semibold hover:shadow-button hover:scale-105 transition-all duration-300",
      },
      size: {
